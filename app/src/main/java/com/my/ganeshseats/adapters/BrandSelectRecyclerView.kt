...
import com.my.ganeshseats.databinding.BrandItemSelectBinding


class BrandSelectRecyclerView(
    private var brandList : MutableList<BrandData>,
    private var myContext: Context,
    private val onItemClick: (BrandData) -> Unit) : RecyclerView.Adapter<BrandSelectRecyclerView.ItemViewHolder>() {

    inner class ItemViewHolder(val binding : BrandItemSelectBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding =  BrandItemSelectBinding.inflate(LayoutInflater.from(parent.context) , parent , false)
