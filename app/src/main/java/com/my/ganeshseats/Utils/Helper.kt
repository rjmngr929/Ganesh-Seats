...
class Helper {
    companion object {
        ...
        fun openWhatsApp(context: Context, phone: String, message: String) {
            ...
            try {
//                val uri = Uri.parse("https://wa.me/$phone?text=${URLEncoder.encode(message, "UTF-8")}")
//                val intent = Intent(Intent.ACTION_VIEW, uri)
        ...
        fun openInstagramProfile(context: Context, username: String, message: String) {
...
//            }
            ...
            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                ...
                setPackage("com.instagram.android") // optional – only Instagram
            }
            try {
